...
/* Private defines -----------------------------------------------------------*/
#define PUMP1_ON_Pin GPIO_PIN_3
#define PUMP1_ON_GPIO_Port GPIOE
#define PUMP2_ON_Pin GPIO_PIN_4
#define PUMP2_ON_GPIO_Port GPIOE
#define PUMP3_ON_Pin GPIO_PIN_5
#define PUMP3_ON_GPIO_Port GPIOE
#define PUMP4_ON_Pin GPIO_PIN_6
#define PUMP4_ON_GPIO_Port GPIOE
